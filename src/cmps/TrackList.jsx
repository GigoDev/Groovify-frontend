                                ...
                                <Draggable key={track.spotifyId} draggableId={track.spotifyId} index={idx}>
                                    {(provided) => (
                                        <li ref={provided.innerRef} {...provided.draggableProps} {...provided.dragHandleProps}>
                                            ...
                                            <span className='add-btn' onClick={() => toggleLikedTrack(track)}>
                                                <svg data-encore-id="icon" fill="#b3b3b3" width="14" height="14" role="img" aria-hidden="true" viewBox="0 0 16 16" className="Svg-sc-ytk21e-0 dYnaPI">
